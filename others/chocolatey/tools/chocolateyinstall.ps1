...
$packageName = 'just-keep-chasing'
$toolsDir = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url = 'https://github.com/mlm-games/just-keep-chasing/releases/download/0.8.13/just-keep-chasing.exe'

$packageArgs = @{
  packageName   = $packageName
  fileType      = 'EXE'
  url           = $url
  softwareName  = 'Just Keep Chasing*'
